    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          GestureDetector(
            onTap: () {
              urlLaunch("https://maps.app.goo.gl/qyYXe8Ku6wTYbNZf6");
            },
            child: Stack(
              children: [
                Container(
                ...
                children: [
                            ...
                            children: [
                              ...
                              GestureDetector(
                                onHorizontalDragUpdate: (details) {
                                  copyTextToClipboard(
                                      context, 'mr.erfanbanaei@gmail.com');
                                },
                                onTap: () {
                                  openEmail();
                                },
                  ...
                  MouseRegion(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        urlLaunch("https://www.linkedin.com/in/erfanbanaeii/");
                      },
                      child: CustomBox(
                        isHover: true,
                        hoverColor: ResumeColor,
              ...
              Column(
                children: [
                  ...
                  MouseRegion(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        urlLaunch("https://github.com/erfanbanaei");
                      },
                      child: CustomBox(
                        isHover: true,
                        hoverColor: ResumeColor,
                  ...
                  MouseRegion(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        urlLaunch("https://x.com/erfan_banaei");
                      },
                      child: CustomBox(
                        isHover: true,
                        hoverColor: ResumeColor,
